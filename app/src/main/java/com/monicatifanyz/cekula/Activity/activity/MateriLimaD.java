...
public class MateriLimaD extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_d);
    ...
    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLima.class);
        startActivity(menu);
    }
}
