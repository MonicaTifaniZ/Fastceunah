...
public class MateriEnamD extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_enam_d);
    ...
    public void menuNext(View v) {
        Intent menu = new Intent(this, MateriEnamT.class);
        startActivity(menu);
    }

    public void menuPrev(View v) {
        Intent menu = new Intent(this, MateriEnam.class);
        startActivity(menu);
    }
}