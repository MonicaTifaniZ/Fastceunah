...
public class MateriTujuhD extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_tujuh_d);
    ...
    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriTujuh.class);
        startActivity(menu);
    }
}
