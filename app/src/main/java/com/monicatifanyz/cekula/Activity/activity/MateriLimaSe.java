...
public class MateriLimaSe extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_se);
    ...
    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLimaDe.class);
        startActivity(menu);
    }
}
