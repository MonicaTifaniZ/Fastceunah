...
public class MateriDelapanS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_delapan_s);
    ...
    public void onBackPressed() {
        Intent i = new Intent(MateriDelapanS.this, MateriDelapan.class);
        startActivity(i);
    }
}
