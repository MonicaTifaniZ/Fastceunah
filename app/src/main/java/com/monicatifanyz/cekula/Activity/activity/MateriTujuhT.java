...
public class MateriTujuhT extends AppCompatActivity implements View.OnClickListener{
    ImageView imageViewNext , imageViewPrev, imageViewHome, imageViewMateri;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_materi_tujuh_t);
...
//        Intent menu = new Intent(this, MateriTujuhT.class);
//        startActivity(menu);
//    }

    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriTujuhD.class);
        startActivity(menu);
    }
}