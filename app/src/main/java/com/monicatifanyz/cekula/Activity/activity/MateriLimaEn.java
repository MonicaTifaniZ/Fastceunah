...
public class MateriLimaEn extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_en);
    ...
    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLimaL.class);
        startActivity(menu);
    }
}
