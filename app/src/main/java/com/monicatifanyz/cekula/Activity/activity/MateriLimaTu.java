...
public class MateriLimaTu extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_tu);
    ...
    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLimaEn.class);
        startActivity(menu);
    }
}
