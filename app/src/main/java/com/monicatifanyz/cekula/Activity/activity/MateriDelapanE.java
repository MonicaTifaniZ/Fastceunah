...
public class MateriDelapanE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_delapan_e);
    ...
    public void onBackPressed() {
        Intent i = new Intent(MateriDelapanE.this, MateriDelapan.class);
        startActivity(i);
    }
}
