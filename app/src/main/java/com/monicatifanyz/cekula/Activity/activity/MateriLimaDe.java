...
public class MateriLimaDe extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_de);
    ...
    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLimaTu.class);
        startActivity(menu);
    }
}
