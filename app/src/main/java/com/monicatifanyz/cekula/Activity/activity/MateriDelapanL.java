...
public class MateriDelapanL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_delapan_l);
    ...
    public void onBackPressed() {
        Intent i = new Intent(MateriDelapanL.this, MateriDelapan.class);
        startActivity(i);
    }
}
