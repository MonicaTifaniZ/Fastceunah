...
public class MateriDelapanEm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_delapan_em);
    ...
    public void onBackPressed() {
        Intent i = new Intent(MateriDelapanEm.this, MateriDelapan.class);
        startActivity(i);
    }
}
