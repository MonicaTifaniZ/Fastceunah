...
public class MateriEmpatD extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_empat_d);
    ...
    public void menuNext(View v){
        Intent menu = new Intent(this, MateriEmpatT.class);
        startActivity(menu);
    }

    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriEmpat.class);
        startActivity(menu);
    }
