...
public class MateriLimaSeb extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_seb);
    ...
    public void menuNext(View v){
        Intent menu = new Intent(this, MateriLimaDuab.class);
        startActivity(menu);
    }

    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLimaTen.class);
        startActivity(menu);
    }
}
