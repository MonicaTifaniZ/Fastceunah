...
public class MateriDelapanD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_delapan_d);
    ...
    public void onBackPressed() {
        Intent i = new Intent(MateriDelapanD.this, MateriDelapan.class);
        startActivity(i);
    }
}
