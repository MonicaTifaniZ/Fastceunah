...
public class MateriLimaDuab extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi_lima_duab);
...
//        Intent menu = new Intent(this, MateriLimaT.class);
//        startActivity(menu);
//    }

    public void menuPrev(View v){
        Intent menu = new Intent(this, MateriLimaSeb.class);
        startActivity(menu);
    }
}
